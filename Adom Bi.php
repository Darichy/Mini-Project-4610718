...
<title>HostMe/Adom bi Hostel</title>
	<script type="text/javascript">function message(){alert("Thanks for submitting your comment")}</script>
	<style>
		body{
			background:#fff;
			position:relative;
...
<body>
	...
	<div class="slider-box">
        <div id="slider">
            <img src="Images/Hostel/adom1.jfif" alt="">
            <img src="Images/Hostel/adom2.jfif" alt="">
            <img src="Images/Hostel/adom3.jfif" alt="">
            <img src="Images/Hostel/adom4.jfif" alt="">
			<img src="Images/Hostel/adom1.jfif" alt="">
            <img src="Images/Hostel/adom2.jfif" alt="">
            <img src="Images/Hostel/adom3.jfif" alt="">
            <img src="Images/Hostel/adom4.jfif" alt="">
            ...
            <img src="Images/Hostel/adom2.jfif" alt="">
            <img src="Images/Hostel/adom3.jfif" alt="">
			<img src="Images/Hostel/adom4.jfif" alt=""><img src="Images/Hostel/adom1.jfif" alt="">
			<img src="Images/Hostel/adom2.jfif" alt="">
			<img src="Images/Hostel/adom3.jfif" alt="">
			<img src="Images/Hostel/adom4.jfif" alt="">
			<img src="Images/Hostel/adom2.jfif" alt="">
	...
	<h1>Adom Bi Hostel</h1>
<p>An affordable hostel located at Kotei, Kumasi, Adom bi hostel has a conducive atmosphere for learning. Students like this hostel due to its closeness to the Ayeduase gate.</p> <button id="btn" >Contact Hostel</a></button>
<div class="alert">
...
<div class="comment">	
<Textarea id="text" placeholder="Any comment about this hostel?"></Textarea>
<input type = "submit" id="com" value = "Submit Comment" name="submit" onclick= Clear()>
</div>
	<script>
       function Clear(){
...
Ayeduase, Kumasi
			...
			<div class="header">
			<div  class="logout"><a href="index.php" onclick="return confirm('Are you sure you want to log out?');">Log out</a>
	</div>
		<div class="head"><ul>
	...
	<div class="icons"><img src="Icons/bx-menu.svg" height="48px" style="margin-left:15px; margin-top:6px; cursor:pointer;" onclick="openSideMenu()" 
</div>
			</div>
	<div id="side-menu" class="side-nav">
	<a href="#" class="btn-close" onclick="closeSideMenu()">&times;</a>	
	<a href="#"><img src="Icons/bxs-home.svg" style="margin-right:60px;">	Home </a>
	<a href="About.php"><img src="Icons/bxs-info-circle.svg" style="margin-right:60px;">About </a>
	<a href="contact.php"><img src="Icons/bxs-contact.svg" style="margin-right:60px;">Contact Us </a>	
	<a href="News.php"><img src="Icons/bxs-news.svg" style="margin-right:60px;">News </a>
		
	<div class="user">
		<div>
		<img src="Images/2021-04-18 22.51 (1).jpg" alt="">
		</div>	
		<div style="margin-top:15px;">
		<b>Web Designer</b>
		<div class="m">	
		<span>Dankwah Richard</span>
		</div>	
		</div>
	</div>	
	</div>
