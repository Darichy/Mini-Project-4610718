...
<body>
	...
	<a href="Evandy.php" class="items" >
	<span>Evandy Hostel</span><small>3.5km from campus</small>	
	<div><img src="Images/Hostel/download (1).jfif"></div>
		...
		<div style="margin-top:10px; margin-left:300px;"> An affordable hostel located at Ayeduase, Kumasi, Adom bi hostel has a conducive atmosphere for learning. Students like this hostel due to its closeness to the Ayeduase gate.
		<div><ul>
			<li>WiFi</li>
			<li>No Gate closing time</li>
			<li>Have rooms with TV and without </li>
			</ul></div>
		</div>
	<a>
	...
	<div class="icons"><img src="Icons/bx-menu.svg" height="48px" style="margin-left:15px; margin-top:6px" ></div>
		<div class="locs">	
		<b>Location</b>		
		<div class="loc"><img src="Icons/search-regular-36.png" style="margin-top:0px;"><p>Bomso</p></div>
		</div>
</div>
