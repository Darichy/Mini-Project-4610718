...
<body>
	...
	<div><img src="Images/Hostel/adom-bi-hostel.webp"></div>
		...
		<div style="margin-top:10px; margin-left:300px; line-height:1.35em"> An affordable hostel located at Ayeduase, Kumasi, Adom bi hostel has a conducive atmosphere for learning. Students like this hostel due to its closeness to the Ayeduase gate.
		<ul>
		<li>Cloud Wi-Fi available</li>
		<li>Electric plant available</li>
		<li>No gate closing time</li>	
		</ul>
	...
	<span>Happy Family hostel</span><small>2.5km from campus</small>	
	<div><img src="Images/Hostel/IMG_1586-281.webp"></div>
		...
		<div style="margin-top:10px; margin-left:300px;"> An affordable hostel located at Ayeduase, Kumasi, Happy Family  hostel has a conducive atmosphere for learning. Students like this hostel due to its closeness to the Ayeduase gate. 
		<ul>
		<li>Cloud Wi-Fi available</li>
		<li>Electric plant available</li>
		<li>No gate closing time</li>	
	...
	<div><img src="Images/Hostel/nyame-mireku.jpg"></div>
	  <div style="display:flex"><span style="height:19px; margin-top:21px; margin-left:110px;">Ratings</span> <span style="height:19px; border:3px solid orange; background:orange; color:white; border-radius:5px; margin-top:21px;">7.1</span></div>
		...
		Nyame Mireku is also known by some as NM Plaza. This hostel is designed in flats. About 3 or four rooms make up a flat and all those rooms share a hall, kitchen and balcony. Its the perfect place to stay with your friends.
		<ul>
		<li>Cloud Wi-Fi available</li>
		<li>Electric plant available</li>
		<li>No gate closing time</li>	
	...
	<div><img src="Images/index.jpg"></div>
		...
		<div style="margin-top:10px; margin-left:300px;">	
		Nyame Mireku is also known by some as NM Plaza. This hostel is designed in flats. About 3 or four rooms make up a flat and all those rooms share a hall, kitchen and balcony. Its the perfect place to stay with your friends.
			<img src="Icons/wifi-regular-24.png" alt=""></div>
	...
	<div class="icons"><img src="Icons/bx-menu.svg" height="48px" width="48px" style="margin-left:15px; margin-top:6px; cursor:pointer;" onClick="openSideMenu()" ></div>
		<div class="locs">	
		<b>Location</b>		
		<div class="loc"><img src="Icons/search-regular-36.png" style="margin-top:0px;"><p>Ayeduase</p></div>
		</div>
</div>
